...
""" sea tabla1,tabla2,tablaN tablas obtenidas de la filtracion de datos
la funcion unir(),contiene innerjoin capaz de unir dichas tablas en una sola
"""
function unir(tabla1::DataFrame,tabla2::DataFrame,tablaN::DataFrame,ID::String)

innerjoin(tabla1,tabla2,tablaN,on=:ID,mekeunique=true)
